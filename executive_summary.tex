...
\input{headers/config_exe}

% Insert here the info that will be displayed into your Title page 
% -> title of your work
\renewcommand{\title}{Development of an Autonomous Mobile Manipulator for Industrial and Agricultural Environments}
...
%%     THESIS MAIN TEXT     %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapters/executive_doc.tex}
%---------------------------------------------------------------------------
%  BIBLIOGRAPHY
%---------------------------------------------------------------------------
